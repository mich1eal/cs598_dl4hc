...
\citeauthor{burger_2021} generated kNN models for selected values of k from 2 to 100. As a distance metric, these models used the cosine distance between utterance embeddings. k=4 gave the best results for classification models, and k=5 was best for regression models.
