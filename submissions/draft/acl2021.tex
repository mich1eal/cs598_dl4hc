...
\begin{enumerate}
    ...
    \item Each classifier outperforms the corresponding regression model on the ``Health" schema. The closest-scoring pair is the multi-label RNN classifier with 0.31 [0.27, 0.34], and the per-schema RNN regressor with 0.28 [0.20, 0.35].
\end{enumerate}
