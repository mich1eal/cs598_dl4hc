...
Per-schema LSTMs, i.e. one LSTM for each schema (classification algorithm)
...
Dataset #2 was used for additional studies. It is hypothesized that keeping common words in the data may improve performance, especially when using larger, more expressive models. 
