...
We struggled to precisely replicate the authors results. We intentionally switched python packages, but we recieved more variance than expected. We also noted large chagnes in results based on hyperparameter changes, such as learning rate, sample, etc. 
...
Authors were contacted on 5/1/2021.
